        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-foreground/70 leading-relaxed font-light">
              <p>Меня зовут Олег, я окончил психфак МГУ и уже длительное время занимаюсь психотерапией и преподаю пстхологию. Я специализируюсь на когнитивно-поведенческой терапии и помогаю людям справляться с тревогой, депрессией, стрессом и другими эмоциональными трудностями.</p>
              <p>
